...
function CutterDensityHeightPickupFix.prerequisitesPresent(specializations)
...
function CutterDensityHeightPickupFix:getAllowCutterAIFruitRequirements(superFunc)
    return false -- block changing of required fruit type since we are doing this on our own
end
