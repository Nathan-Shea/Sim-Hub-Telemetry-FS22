...
function ManureSensor.initSpecialization()
    g_configurationManager:addConfigurationType("manureSensor", g_i18n:getText("configuration_manureSensor"), "manureSensor", nil, nil, nil, ConfigurationUtil.SELECTOR_MULTIOPTION)
