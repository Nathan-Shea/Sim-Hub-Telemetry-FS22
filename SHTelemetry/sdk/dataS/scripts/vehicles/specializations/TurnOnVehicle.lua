...
function TurnOnVehicle:onLoad(savegame)
    ...
    if self.isClient then
        ...
        if self.loadDashboardsFromXML ~= nil then
            self:loadDashboardsFromXML(self.xmlFile, "vehicle.turnOnVehicle.dashboards", {valueTypeToLoad = "turnedon",
                                                                                          valueObject = spec,
                                                                                          valueFunc = "isTurnedOn"})
            self:loadDashboardsFromXML(self.xmlFile, "vehicle.turnOnVehicle.dashboards", {valueTypeToLoad = "rpm",
                                                                                          valueObject = self,
