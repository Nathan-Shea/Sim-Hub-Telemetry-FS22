...
function Motorized.initSpecialization()
    ...
    g_storeManager:addSpecType("powerConfig",    "shopListAttributeIconPower",           Motorized.loadSpecValuePowerConfig,  Motorized.getSpecValuePowerConfig, "vehicle")  -- used for export only
...
function Motorized:onLoad(savegame)
    ...
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.turnedOnRotationNodes.turnedOnRotationNode#type", "vehicle.motor.animationNodes.animationNode", "motor") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.differentialConfigurations", "vehicle.motorized.differentialConfigurations") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.motorConfigurations", "vehicle.motorized.motorConfigurations") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.maximalAirConsumptionPerFullStop", "vehicle.motorized.consumerConfigurations.consumerConfiguration.consumer(with fill type 'air')#usage (is now in usage per second at full brake power)") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.indoorHud.rpm", "vehicle.motorized.dashboards.dashboard with valueType 'rpm'") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.indoorHud.speed", "vehicle.motorized.dashboards.dashboard with valueType 'speed'") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.indoorHud.fuelUsage", "vehicle.motorized.dashboards.dashboard with valueType 'fuelUsage'") --FS17 to FS19
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.indoorHud.fuel", "fillUnit.dashboard with valueType 'fillLevel'") --FS17 to FS19

    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.motor", "vehicle.motorized.motorConfigurations.motorConfiguration(?).motor") --FS19 to FS22
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.transmission", "vehicle.motorized.motorConfigurations.motorConfiguration(?).transmission") --FS19 to FS22
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.fuelCapacity", "vehicle.motorized.consumerConfigurations.consumerConfiguration.consumer#capacity") --FS19 to FS22
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.motorized.motorConfigurations.motorConfiguration(?).fuelCapacity", "vehicle.motorized.consumerConfigurations.consumerConfiguration.consumer#capacity") --FS19 to FS22
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle#consumerConfigurationIndex", "vehicle.motorized.motorConfigurations.motorConfiguration(?)#consumerConfigurationIndex'") --FS19 to FS22

    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.motorized.exhaustParticleSystems#count") --FS19 to FS22
    XMLUtil.checkDeprecatedXMLElements(self.xmlFile, self.configFileName, "vehicle.motorized.exhaustParticleSystems.exhaustParticleSystem1", "vehicle.motorized.exhaustParticleSystems.exhaustParticleSystem") --FS19 to FS22
    ...
    if self.loadDashboardsFromXML ~= nil then
        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "rpm",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = "getLastModulatedMotorRpm",
                                                                                  minFunc = 0,
                                                                                  maxFunc = "getMaxRpm"})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "load",
                                                                                  valueObject = spec.motor,
        ...
        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "speed",
                                                                                  valueObject = self,
                                                                                  valueFunc = "getLastSpeed",
                                                                                  minFunc = 0,
                                                                                  maxFunc = self:getMotor():getMaximumForwardSpeed()*3.6})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "speedDir",
                                                                                  valueObject = self,
        ...
        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "fuelUsage",
                                                                                  valueObject = spec,
                                                                                  valueFunc = "lastFuelUsageDisplay"})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "motorTemperature",
                                                                                  valueObject = spec.motorTemperature,
                                                                                  valueFunc = "value",
                                                                                  minFunc = "valueMin",
                                                                                  maxFunc = "valueMax"})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "motorTemperatureWarning",
                                                                                  valueObject = spec.motorTemperature,
                                                                                  valueFunc = "value",
                                                                                  additionalAttributesFunc = Dashboard.warningAttributes,
                                                                                  stateFunc = Dashboard.warningState})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "clutchPedal",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = "getSmoothedClutchPedal",
                                                                                  minFunc = 0,
                                                                                  maxFunc = 1})
        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "gear",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = "getGearToDisplay",
                                                                                  minFunc = 0,
                                                                                  maxFunc = math.huge})
        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "gearGroup",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = "getGearGroupToDisplay",
                                                                                  minFunc = 0,
                                                                                  maxFunc = math.huge})
        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "movingDirection",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = "getDrivingDirection",
                                                                                  minFunc = -1,
                                                                                  maxFunc = 1})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "directionForward",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = function(motor)
                                                                                      return motor:getDrivingDirection() >= 0
                                                                                  end})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "directionForwardExclusive",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = function(motor)
                                                                                      return motor:getDrivingDirection() > 0
                                                                                  end})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "directionBackward",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = function(motor)
                                                                                      return motor:getDrivingDirection() < 0
                                                                                  end})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "movingDirectionLetter",
                                                                                  valueObject = spec.motor,
                                                                                  valueFunc = function(motor)
                                                                                      return motor:getDrivingDirection() == 1 and "F" or (motor:getDrivingDirection() == -1 and "R" or "N")
                                                                                  end})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "ignitionState",
                                                                                  valueObject = self,
                                                                                  valueFunc = Motorized.getMotorIgnitionState,
                                                                                  minFunc = 0,
                                                                                  maxFunc = 2})

        self:loadDashboardsFromXML(self.xmlFile, "vehicle.motorized.dashboards", {valueTypeToLoad = "battery",
                                                                                  valueObject = self,
        ...
        if self.isClient then
            ...
            if g_soundManager:getIsSamplePlaying(spec.motorSamples[1], 1.5*dt) then
                ...
                if spec.motor.blowOffValveState > 0 then
                    ...
                    if g_soundManager:getIsSamplePlaying(samples.blowOffValve) then
...
function Motorized:onUpdateTick(dt, isActiveForInput, isActiveForInputIgnoreSelection, isSelected)
    ...
    if self.isServer then
        ...
        if not g_currentMission.missionInfo.automaticMotorStartEnabled then
            if spec.isMotorStarted and not self:getIsAIActive() then
...
function Motorized:loadExhaustEffects(xmlFile)
    ...
    XMLUtil.checkDeprecatedXMLElements(xmlFile, self.configFileName, "vehicle.motorized.exhaustFlap#index", "vehicle.motorized.exhaustFlap#node") --FS17 to FS19
    ...
    if exhaustFlapNode ~= nil then
        spec.exhaustFlap = {}
        spec.exhaustFlap.node = exhaustFlapNode
        spec.exhaustFlap.maxRot = xmlFile:getValue("vehicle.motorized.exhaustFlap#maxRot", 0)
        spec.exhaustFlap.rotationAxis = xmlFile:getValue("vehicle.motorized.exhaustFlap#rotationAxis", 1)
    end
...
-- @return boolean isStarted motor is started
...
function Motorized:getMotorIgnitionState()
    return self.spec_motorized.isMotorStarted and (self.spec_motorized.motorStartTime > g_currentMission.time and 1 or 2) or 0
end
...
function Motorized:getStopMotorOnLeave()
    if GS_IS_MOBILE_VERSION then
        if self.rootVehicle:getActionControllerDirection() == -1 then
            return false
        end
    end
...
function Motorized:startMotor(noEventSend)
    ...
    -- wake up physics to update the motor attributes at least once
    if self.isServer then
        self:wakeUp()
    end
end
...
function Motorized:getIsDashboardGroupActive(superFunc, group)
    ...
    if group.isMotorStarting and not group.isMotorRunning then
        if not spec.isMotorStarted or spec.motorStartTime < g_currentMission.time then
            return false
        end
    end
...
function Motorized:controlVehicle(acceleratorPedal, maxSpeed, maxAcceleration, minMotorRotSpeed, maxMotorRotSpeed, maxMotorRotAcceleration, minGearRatio, maxGearRatio, maxClutchTorque, neededPtoTorque)
    ...
    -- wake up the phyiscs if the value change while the motorized node is sleeping to force an update
