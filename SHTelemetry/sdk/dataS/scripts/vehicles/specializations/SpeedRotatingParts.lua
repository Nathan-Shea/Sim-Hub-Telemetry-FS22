    ...
    for _, speedRotatingPart in pairs(spec.speedRotatingParts) do
        if speedRotatingPart.wheel ~= nil then
            ...
            if speedRotatingPartsNodes[node] ~= nil then
                local nodeData = {}
                nodeData.wheel = speedRotatingPart.wheel
                nodeData.fieldDirtMultiplier = speedRotatingPart.wheel.fieldDirtMultiplier
                nodeData.streetDirtMultiplier = speedRotatingPart.wheel.streetDirtMultiplier
                nodeData.minDirtPercentage = speedRotatingPart.wheel.minDirtPercentage
                nodeData.maxDirtOffset = speedRotatingPart.wheel.maxDirtOffset
                nodeData.dirtColorChangeSpeed = speedRotatingPart.wheel.dirtColorChangeSpeed
