...
function Foldable.initSpecialization()
    g_configurationManager:addConfigurationType("folding", g_i18n:getText("configuration_folding"), "foldable", nil, nil, nil, ConfigurationUtil.SELECTOR_MULTIOPTION)
...
-- @return bool success successfully loaded folding part
...
function Foldable:getToggledFoldDirection()
    ...
    elseif spec.foldMoveDirection > 0.1 or (spec.foldMoveDirection == 0 and spec.foldAnimTime > foldMidTime) then
        return -1
    else
        return 1
    end
