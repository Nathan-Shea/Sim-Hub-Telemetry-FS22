...
function AIImplement.initSpecialization()
    g_configurationManager:addConfigurationType("ai", g_i18n:getText("configuration_design"), "ai", nil, nil, nil, ConfigurationUtil.SELECTOR_MULTIOPTION)
...
function AIImplement:createFieldCropsQuery()
    ...
    if groundTypeMapId ~= nil then
        ...
        --#debug    if spec.fieldCropyQueryValid then
        --#debug        spec.debugArea = DebugBitVectorMap.new(15, 0.5, 0.05, 0.1)
