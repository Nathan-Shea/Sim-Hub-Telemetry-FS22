...
function VariableWorkWidth.initSpecialization()
    g_configurationManager:addConfigurationType("variableWorkWidth", g_i18n:getText("configuration_workingWidth"), "variableWorkWidth", nil, nil, nil, ConfigurationUtil.SELECTOR_MULTIOPTION)
...
-- @param bool isLeft is left effect
-- @return float width width
-- @return float maxWidth max width
-- @return bool isValid is valid - has variable working width sections
