...
function FillVolume.initSpecialization()
    g_configurationManager:addConfigurationType("fillVolume", g_i18n:getText("configuration_fillVolume"), "fillVolume", nil, nil, nil, ConfigurationUtil.SELECTOR_MULTIOPTION)
