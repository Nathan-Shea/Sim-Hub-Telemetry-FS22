...
function AIVehicle:loadAIAgentAttachmentsFromXML(xmlFile, baseKey, agentAttachments, loadSubAttachments, requiresJointNode)
    xmlFile:iterate(baseKey, function(index, key)
        ...
        agentAttachment.width = xmlFile:getValue(key .. "#width", 3)
        agentAttachment.height = xmlFile:getValue(key .. "#height", 3)
        agentAttachment.heightOffset = xmlFile:getValue(key .. "#heightOffset", 0)
        agentAttachment.length = xmlFile:getValue(key .. "#length", 3)
        agentAttachment.lengthOffset = xmlFile:getValue(key .. "#lengthOffset", 0)
