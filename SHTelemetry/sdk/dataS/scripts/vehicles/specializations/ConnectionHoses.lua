...
function ConnectionHoses:getClonedSkipHoseNode(sourceHose, skipNode)
    ...
    clonedHose.color = sourceHose.color
                    ...
                    if toolConnectionHose.additionalHose then
                        ...
                        if hose ~= nil then
                            ...
                            if dirX ~= 0 or dirY ~= nil or dirZ ~= nil then
                                ...
                                setShaderParameter(hose, "cv2", dirX*0.5+0.003, dirY*0.5, dirZ*0.5, 0, false) -- center point
                                setShaderParameter(hose, "cv3", dirX-0.003, dirY, dirZ, 0, false) -- target point
                                setShaderParameter(hose, "cv4", dirX-0.003, dirY, dirZ+dirZ*0.5, 0, false) -- end straightening point
                            end
