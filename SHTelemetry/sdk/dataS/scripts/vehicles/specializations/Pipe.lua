...
function Pipe.initSpecialization()
    g_configurationManager:addConfigurationType("pipe", g_i18n:getText("configuration_pipe"), "pipe", nil, nil, nil, ConfigurationUtil.SELECTOR_MULTIOPTION)
...
function Pipe:onLoad(savegame)
    ...
    spec.nearestObjectInTriggers = {objectId=nil, fillUnitIndex=0}
    spec.nearestObjectInTriggersSent = {objectId=nil, fillUnitIndex=0}
    ...
    spec.texts.pipeIn = g_i18n:getText("action_pipeIn")
    spec.texts.pipeOut = g_i18n:getText("action_pipeOut")
        ...
        if node ~= nil then
            ...
            while true do
                ...
                if regulationNode.node ~= nil then
                    ...
                    regulationNode.weights[MathUtil.clamp(axis, 1, 3)] = direction
