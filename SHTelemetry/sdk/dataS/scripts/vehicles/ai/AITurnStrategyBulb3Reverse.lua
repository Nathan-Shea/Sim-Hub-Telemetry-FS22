...
function AITurnStrategyBulb3Reverse:updateTurningSizeBox(box, turnLeft, turnData, lookAheadDistance)
    ...
    --local bulbLength = c2Z + math.max(turnData.sideOffsetLeft, turnData.sideOffsetRight, turnData.toolOverhang.back.xt, turnData.toolOverhang.back.zt, turnData.toolOverhang.front.xt, turnData.toolOverhang.front.zt)
    --c1Z = c1Z - bulbLength
    --c2Z = c2Z - bulbLength
