...
-- @param float tY local space y position
-- @param float maxSpeed speed limit
-- @param boolean doNotSteer do not steer
...
-- @param table vehicle vehicle to check
-- @return integer aiToolReverserDirectionNode reverser direction node of ai tool
