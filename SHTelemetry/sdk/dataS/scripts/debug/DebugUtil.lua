...
-- @param integer steps steps
-- @param table color color [r, g, b, a]
-- @param bool vertical circle is drawed vertically
...
-- @param node to draw a reference axis from
...
-- @param float up y
-- @param float up z
-- @param float direction x
-- @param float direction y
-- @param float direction z
