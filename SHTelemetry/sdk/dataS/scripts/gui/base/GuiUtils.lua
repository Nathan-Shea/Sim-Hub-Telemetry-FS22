...
-- @param str Attribute string containing exactly 2 numbers
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return Array of the 2 converted values as numbers: {value1, value2}
function GuiUtils.get2DArray(str, defaultValue)
    if str ~= nil then
        local parts = str:split(" ")
        local x,y = unpack(parts)
        if x ~= nil and y ~= nil then
            return {Utils.evaluateFormula(x), Utils.evaluateFormula(y)}
        end
    end
...
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return Array of the 4 converted values as numbers: {value1, value2, value3, value4}
function GuiUtils.get4DArray(str, defaultValue)
...
-- @param str Attribute string containing exactly 4 numbers
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return Array of the 4 converted values as numbers: {red, green, blue, alpha}
...
-- @param str Attribute string containing exactly 4 numbers
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return Array of the 4 converted values as numbers: {red, green, blue, alpha}, or 16 numbers: 4x rgba.
...
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return Array of the UV coordinates as {u1, v1, u2, v2, u3, v3, u4, v4}
...
function GuiUtils.checkOverlayOverlap(posX, posY, overlayX, overlayY, overlaySizeX, overlaySizeY, hotspot)
    if hotspot ~= nil and #hotspot == 4 then
        return overlaySizeX > 0 and overlaySizeY > 0
           ...
           and posY >= overlayY + hotspot[2]
           and posY <= overlayY + overlaySizeY + hotspot[4]
    else
        return overlaySizeX > 0 and overlaySizeY > 0
           and posX >= overlayX
