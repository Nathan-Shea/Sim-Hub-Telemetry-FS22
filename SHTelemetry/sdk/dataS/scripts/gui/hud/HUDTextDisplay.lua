...
-- @param int textAlignment Text alignment as one of RenderText.[ALIGN_LEFT | ALIGN_CENTER | ALIGN_RIGHT]
-- @param table textColor Text display color as an array {r, g, b, a}
-- @param bool textBool If true, will render the text in bold
...
-- @param bool animate If true, will play the currently set animation on becoming visible or and reset it when necessary.
...
-- @param bool isShadowEnabled If true, will cause a shadow to be rendered under the text
