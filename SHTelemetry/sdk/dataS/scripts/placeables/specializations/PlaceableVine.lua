...
--                     debugArea:delete()
--                     g_debugManager:removePermanentElement(debugArea)
--                 end
            end
        end
...
--             local debugArea = Debug2DArea.new(true, false, {0, 0.7 * (i / spec.numSections), 0, 0.1})
--             debugArea:createWithPositions(startX, nil, startZ, widthX, nil, widthZ, heightX, nil, heightZ)
--             data.sectionDebugAreas[i] = debugArea
--             g_debugManager:addPermanentElement(debugArea)
