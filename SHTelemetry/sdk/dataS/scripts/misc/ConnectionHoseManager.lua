...
function ConnectionHoseManager:materialI3DFileLoaded(i3dNode, failedReason, args)
    ...
    if i3dNode ~= nil and i3dNode ~= 0 then
        ...
        if materialNode ~= nil then
            ...
            entry.defaultColor = xmlFile:getValue(hoseKey .. "#defaultColor", nil, true)
            entry.uvOffset = xmlFile:getValue(hoseKey .. "#uvOffset", nil, true)
            entry.uvScale = xmlFile:getValue(hoseKey .. "#uvScale", nil, true)
...
function ConnectionHoseManager:socketI3DFileLoaded(i3dNode, failedReason, args)
    ...
    if i3dNode ~= nil and i3dNode ~= 0 then
        ...
        if node ~= nil then
            ...
            entry.shaderParameterColor = xmlFile:getValue(socketKey .. "#shaderParameterColor")
        ...
        if material ~= nil then
            ...
            if hoseNodeClone ~= nil then
                ...
                if material.uvScale ~= nil then
                    scaleFactorX, scaleFactorY = material.uvScale[1], material.uvScale[2]
                end
